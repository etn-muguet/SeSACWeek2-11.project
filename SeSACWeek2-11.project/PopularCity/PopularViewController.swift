...
struct City {
    ...
    let city: [City] = [City(city_name: "방콕", city_english_name: "Bangkok", city_explain: "방콕, 파타야, 후아힌, 코사멧, 코사무이", city_image: "https://images.unsplash.com/photo-1716872491897-078d9b89be49?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", domestic_travel: false),
...
class PopularViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        myTableView.register(xib, forCellReuseIdentifier: "PopularTableViewCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let url = URL(string: city[indexPath.row].city_image)
        ...
        cell.cityName.font = .systemFont(ofSize: 20, weight: .bold)
        
        
        cell.subtitleLabel.text = city[indexPath.row].city_explain
        cell.subtitleView.backgroundColor = .black.withAlphaComponent(0.5)
